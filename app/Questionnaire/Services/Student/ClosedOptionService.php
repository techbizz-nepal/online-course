...
class ClosedOptionService extends BaseStudent implements InterfaceStudent
{
    public const RELATION_NAME = 'option';

    public const VIEW_PATH = 'questionnaire.student.type.closed-options';
