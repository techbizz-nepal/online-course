...
@section('content')
    ...
    <div class="main-content pt-lg-4">
        ...
        <div class="w-100 h-100 bg-white mx-2 p-2">
            <form
                action="{{ route('admin.courses.assessments.update', ['course'=>$course->slug, 'assessment'=>$assessment]) }}"
                method="POST"
                ...
                <div class="form-group row">
                    <div class="col-6">
                        ...
                        <input required class="form-control @error('name') is-invalid @enderror" type="text" name="name"
                               value="{{ $assessment->name ?? @old('name')}}"
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input @readonly(true)
                                   ...
                                   name="material"
                                   id="material"
                                   value="{{$assessment->material ?? @old('material')}}">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                  ...
                                  placeholder="Description">{{$assessment->description ?? @old('description')}}</textarea>
                        @error('description')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
...
@push('js')
    ...
    <script>
        const requestPath = `{{route('admin.courses.assessments.updateMaterial', [$course, $assessment])}}`
