            ...
            <form action="{{ route('student.updateProfile') }}" method="POST">
                ...
                <div class="form-row mb-5">
                    ...
                    <x-form.input label="First Name" name="first_name" id="first_name" type="text"
                                  ...
                                  required="true" placeholder="your first name" cols="col-md-8 col-4"/>

                    <x-form.input label="Last Name" name="surname" id="surname" type="text" :value="$student['surname']"
                                  required="true" placeholder="your last name" cols="col-md-8 col-4"/>
                ...
                <div class="form-row mb-5">
                    ...
                    <x-form.input label="Home Phone" name="home_phone" id="home_phone" type="tel" required="true"
                                  ...
                                  placeholder='1234567890' pattern="[0-9]{10}" cols="col-md-8 col-3"/>

                    <x-form.input label="Work Phone" name="work_phone" id="work_phone" type="tel" required="true"
                                  :value="$student['work_phone']"
                                  placeholder='1234567890' pattern="[0-9]{10}" cols="col-md-8 col-3"/>

                    <x-form.input label="Mobile" name="mobile" id="mobile" type="tel" placeholder='1234567890'
                                  :value="$student['mobile']"
                                  required="true" pattern="[0-9]{10}" cols="col-md-8 col-3"/>

                    <x-form.input label="Email" name="email" id="email" type="email" placeholder='abc@abc.com'
                                  required="true" cols="col-md-8 col-3" :value="$student['email']" :readonly="true"/>
                </div>
                <div class="form-row mb-5">
                    <h4 class="col-12 mb-2">Address</h4>
                    <x-form.input label="Flat/Unit" name="flat_unit" id="flat_unit" type="text" placeholder='#flat/unit'
                                  :value="$student['flat_unit']" required="true" cols="col-md-8 col-2"/>

                    <x-form.input label="Street" name="street" id="street" type="text" placeholder='92 McPherson Road'
                    ...
                    <x-form.input label="Suburb, locality or town" name="locality" id="locality" type="text"
                                  required="true" placeholder='Great Southern' :value="$student['locality']"
                                  cols="col-md-8 col-3"/>

                    <x-form.input label="State/Territory" name="state" id="state" type="text" placeholder='VIC'
                                  required="true" cols="col-md-8 col-2" :value="$student['state']"/>

                    <x-form.input label="Post Code" name="post_code" id="post_code" type="number" placeholder='3685'
                ...
                <div class="form-row mb-5">
                    ...
                    <x-form.input label="Name" name="emergency_name" id="emergency_name" type="text"
                                  :value="$student['emergency_name']" placeholder='your friends/family name'
                                  cols="col-md-8 col-3"/>

                    <x-form.input label="Relationship to you" name="relation" id="relation" type="text"
                                  :value="$student['relation']" placeholder='relationship to you'
                                  cols="col-md-8 col-3"/>

                    <x-form.input label="Home Phone" name="emergency_home_phone" id="emergency_home_phone" type="tel"
                                  placeholder='1234567890' required="true" pattern="[0-9]{10}"
